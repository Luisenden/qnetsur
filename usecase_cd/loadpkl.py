...
surs = []
for name in glob.glob('../../surdata/CD/tree2-3/Sur_ND*'):
...
fig, ax = plt.subplots()
g = sns.lineplot(data = dfs, x=r'# optimization steps', y=r'# virtual neighbours', hue='Method', style='Method', markers='^') # plot the Number of Neighbours for all methods
